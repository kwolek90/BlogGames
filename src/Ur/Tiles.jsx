...
export class NewGameTile extends Tile {
    constructor(x, y, w, h) {
        super(x, y, w, h);
    }
    draw() {
...
export class RouteTile extends Tile {
    constructor(x, y, w, h) {
        super(x, y, w, h);
        this.pawn = null;
...
export class BeginTile extends RouteTile {
    constructor(x, y, w, h) {
        super(x, y, w, h);
        this.pawns = [];
    }
...
export class EndTile extends RouteTile {
...
export class RollTile extends Tile {
    constructor(x, y, w, h) {
        super(x, y, w, h);
